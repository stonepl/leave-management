...
namespace leave_management.Repository
{
    ...
    {
        private readonly ApplicationDbContext _db; //connection to database

        public LeaveAllocationRepository(ApplicationDbContext db) //Constructor
        {
            _db = db; //Private _db allocated
        }
